...
object TrainClient {
  ...
  object FacilityState {
    ...
    implicit val decoder: ScalarDecoder[FacilityState] = {
      ...
      case other =>
        Left(DecodingError(s"Can't build FacilityState from input $other"))
    }
  ...
  object FacilityType {
    ...
    implicit val decoder: ScalarDecoder[FacilityType] = {
      ...
      case other =>
        Left(DecodingError(s"Can't build FacilityType from input $other"))
    }
  ...
  object CarAttributes {
    def seats: SelectionBuilder[CarAttributes, Int] =
      _root_.caliban.client.SelectionBuilder.Field("seats", Scalar())
    def color: SelectionBuilder[CarAttributes, String] =
      _root_.caliban.client.SelectionBuilder.Field("color", Scalar())
    def doors: SelectionBuilder[CarAttributes, Int] =
      _root_.caliban.client.SelectionBuilder.Field("doors", Scalar())
    ...
    def licensePlate: SelectionBuilder[CarAttributes, Option[String]] =
      _root_.caliban.client.SelectionBuilder
        .Field("licensePlate", OptionOf(Scalar()))
    def fillLevel: SelectionBuilder[CarAttributes, Option[Int]] =
      _root_.caliban.client.SelectionBuilder
        .Field("fillLevel", OptionOf(Scalar()))
  ...
  object CarEquipment {
    def cdPlayer: SelectionBuilder[CarEquipment, Option[Boolean]] =
      _root_.caliban.client.SelectionBuilder
        .Field("cdPlayer", OptionOf(Scalar()))
    def airConditioning: SelectionBuilder[CarEquipment, Option[Boolean]] =
      _root_.caliban.client.SelectionBuilder
        .Field("airConditioning", OptionOf(Scalar()))
    ...
    def roofRailing: SelectionBuilder[CarEquipment, Option[Boolean]] =
      _root_.caliban.client.SelectionBuilder
        .Field("roofRailing", OptionOf(Scalar()))
    ...
    def audioInline: SelectionBuilder[CarEquipment, Option[Boolean]] =
      _root_.caliban.client.SelectionBuilder
        .Field("audioInline", OptionOf(Scalar()))
    def tyreType: SelectionBuilder[CarEquipment, Option[String]] =
      _root_.caliban.client.SelectionBuilder
        .Field("tyreType", OptionOf(Scalar()))
    def bluetoothHandsFreeCalling
        : SelectionBuilder[CarEquipment, Option[Boolean]] =
      _root_.caliban.client.SelectionBuilder
        .Field("bluetoothHandsFreeCalling", OptionOf(Scalar()))
    def cruiseControl: SelectionBuilder[CarEquipment, Option[Boolean]] =
      _root_.caliban.client.SelectionBuilder
        .Field("cruiseControl", OptionOf(Scalar()))
    def passengerAirbagTurnOff
        : SelectionBuilder[CarEquipment, Option[Boolean]] =
      _root_.caliban.client.SelectionBuilder
  ...
  object Facility {
    ...
    def equipmentNumber: SelectionBuilder[Facility, Option[Int]] =
      _root_.caliban.client.SelectionBuilder
        .Field("equipmentNumber", OptionOf(Scalar()))
    def location[A](
        innerSelection: SelectionBuilder[Location, A]
    ): SelectionBuilder[Facility, Option[A]] =
      _root_.caliban.client.SelectionBuilder
  ...
  object FlinksterBike {
    def id: SelectionBuilder[FlinksterBike, String] =
      _root_.caliban.client.SelectionBuilder.Field("id", Scalar())
    def url: SelectionBuilder[FlinksterBike, String] =
      _root_.caliban.client.SelectionBuilder.Field("url", Scalar())
    def name: SelectionBuilder[FlinksterBike, String] =
    ...
    def location[A](
        innerSelection: SelectionBuilder[Location, A]
    ): SelectionBuilder[FlinksterBike, A] =
      _root_.caliban.client.SelectionBuilder
    ...
    def priceOptions[A](
      ...
      _root_.caliban.client.SelectionBuilder
        .Field("priceOptions", ListOf(OptionOf(Obj(innerSelection))))
    def attributes[A](
        innerSelection: SelectionBuilder[BikeAttributes, A]
    ): SelectionBuilder[FlinksterBike, A] =
      _root_.caliban.client.SelectionBuilder
        .Field("attributes", Obj(innerSelection))
    def address[A](
        innerSelection: SelectionBuilder[MailingAddress, A]
    ): SelectionBuilder[FlinksterBike, A] =
      _root_.caliban.client.SelectionBuilder
    ...
    def `type`: SelectionBuilder[FlinksterBike, String] =
      _root_.caliban.client.SelectionBuilder.Field("type", Scalar())
    def providerRentalObjectId: SelectionBuilder[FlinksterBike, Int] =
      _root_.caliban.client.SelectionBuilder
        .Field("providerRentalObjectId", Scalar())
    def parkingArea[A](
        innerSelection: SelectionBuilder[FlinksterParkingArea, A]
    ): SelectionBuilder[FlinksterBike, A] =
      _root_.caliban.client.SelectionBuilder
  ...
  type FlinksterCar
  object FlinksterCar {
    def id: SelectionBuilder[FlinksterCar, String] =
      _root_.caliban.client.SelectionBuilder.Field("id", Scalar())
    def name: SelectionBuilder[FlinksterCar, String] =
      _root_.caliban.client.SelectionBuilder.Field("name", Scalar())
    def description: SelectionBuilder[FlinksterCar, String] =
      _root_.caliban.client.SelectionBuilder.Field("description", Scalar())
    def attributes[A](
        innerSelection: SelectionBuilder[CarAttributes, A]
    ): SelectionBuilder[FlinksterCar, A] =
      _root_.caliban.client.SelectionBuilder
        .Field("attributes", Obj(innerSelection))
    def location[A](
        innerSelection: SelectionBuilder[Location, A]
    ...
    def priceOptions[A](
      ...
      _root_.caliban.client.SelectionBuilder
        .Field("priceOptions", ListOf(OptionOf(Obj(innerSelection))))
    def equipment[A](
        innerSelection: SelectionBuilder[CarEquipment, A]
    ): SelectionBuilder[FlinksterCar, A] =
      _root_.caliban.client.SelectionBuilder
    ...
    def url: SelectionBuilder[FlinksterCar, String] =
      _root_.caliban.client.SelectionBuilder.Field("url", Scalar())
  }
  ...
  object FlinksterParkingArea {
    ...
    def address[A](
        innerSelection: SelectionBuilder[MailingAddress, A]
    ): SelectionBuilder[FlinksterParkingArea, A] =
      _root_.caliban.client.SelectionBuilder
        .Field("address", Obj(innerSelection))
    def parkingDescription
        : SelectionBuilder[FlinksterParkingArea, Option[String]] =
      _root_.caliban.client.SelectionBuilder
    ...
    def provider[A](
        innerSelection: SelectionBuilder[FlinksterProvider, A]
    ): SelectionBuilder[FlinksterParkingArea, A] =
      _root_.caliban.client.SelectionBuilder
    ...
    def GeoJSON[A](
        innerSelection: SelectionBuilder[GeoJSON, A]
    ): SelectionBuilder[FlinksterParkingArea, Option[A]] =
      _root_.caliban.client.SelectionBuilder
  ...
  object FlinksterProvider {
    def url: SelectionBuilder[FlinksterProvider, String] =
      _root_.caliban.client.SelectionBuilder.Field("url", Scalar())
    ...
    def networkIds: SelectionBuilder[FlinksterProvider, List[Int]] =
      _root_.caliban.client.SelectionBuilder
        .Field("networkIds", ListOf(Scalar()))
  }

  type GeoFeature
  object GeoFeature {
    def `type`: SelectionBuilder[GeoFeature, String] =
      _root_.caliban.client.SelectionBuilder.Field("type", Scalar())
    def properties[A](
        innerSelection: SelectionBuilder[GeoProperties, A]
    ): SelectionBuilder[GeoFeature, A] = _root_.caliban.client.SelectionBuilder
      .Field("properties", Obj(innerSelection))
    def geometry[A](
        innerSelection: SelectionBuilder[GeoPolygon, A]
    ): SelectionBuilder[GeoFeature, A] = _root_.caliban.client.SelectionBuilder
  ...
  type GeoJSON
  object GeoJSON {
    def `type`: SelectionBuilder[GeoJSON, String] =
      _root_.caliban.client.SelectionBuilder.Field("type", Scalar())
    def features[A](
        innerSelection: SelectionBuilder[GeoFeature, A]
    ): SelectionBuilder[GeoJSON, List[A]] =
      _root_.caliban.client.SelectionBuilder
  ...
  type GeoPolygon
  object GeoPolygon {
    def `type`: SelectionBuilder[GeoPolygon, String] =
      _root_.caliban.client.SelectionBuilder.Field("type", Scalar())
    def coordinates: SelectionBuilder[GeoPolygon, List[
      Option[List[Option[List[Option[List[Option[Double]]]]]]]
    ]] = _root_.caliban.client.SelectionBuilder.Field(
      "coordinates",
      ListOf(
        OptionOf(ListOf(OptionOf(ListOf(OptionOf(ListOf(OptionOf(Scalar())))))))
      )
    )
  }
  ...
  object GeoProperties {
    def name: SelectionBuilder[GeoProperties, String] =
      _root_.caliban.client.SelectionBuilder.Field("name", Scalar())
  }
  ...
  object MailingAddress {
    def city: SelectionBuilder[MailingAddress, String] =
      _root_.caliban.client.SelectionBuilder.Field("city", Scalar())
  ...
  object Nearby {
    def stations[A](count: Option[Int] = None, offset: Option[Int] = None)(
      ...
      _root_.caliban.client.SelectionBuilder.Field(
        ...
        arguments = List(
          Argument("count", count, "Int")(encoder0),
  ...
  object Occupancy {
    ...
    def category: SelectionBuilder[Occupancy, Int] =
      _root_.caliban.client.SelectionBuilder.Field("category", Scalar())
    def text: SelectionBuilder[Occupancy, String] =
      _root_.caliban.client.SelectionBuilder.Field("text", Scalar())
  }

  type OpeningTime
  object OpeningTime {
    def from: SelectionBuilder[OpeningTime, String] =
      _root_.caliban.client.SelectionBuilder.Field("from", Scalar())
    def to: SelectionBuilder[OpeningTime, String] =
      _root_.caliban.client.SelectionBuilder.Field("to", Scalar())
  }

  type OpeningTimes
  object OpeningTimes {
    def monday[A](
        innerSelection: SelectionBuilder[OpeningTime, A]
    ): SelectionBuilder[OpeningTimes, Option[A]] =
      _root_.caliban.client.SelectionBuilder
  ...
  object OperationLocation {
    ...
    def locationCode: SelectionBuilder[OperationLocation, Option[String]] =
      _root_.caliban.client.SelectionBuilder
        .Field("locationCode", OptionOf(Scalar()))
    def UIC: SelectionBuilder[OperationLocation, String] =
      _root_.caliban.client.SelectionBuilder.Field("UIC", Scalar())
    def regionId: SelectionBuilder[OperationLocation, Option[String]] =
      _root_.caliban.client.SelectionBuilder
        .Field("regionId", OptionOf(Scalar()))
    ...
    def validTill: SelectionBuilder[OperationLocation, Option[String]] =
      _root_.caliban.client.SelectionBuilder
        .Field("validTill", OptionOf(Scalar()))
    def timeTableRelevant
        : SelectionBuilder[OperationLocation, Option[Boolean]] =
      _root_.caliban.client.SelectionBuilder
        .Field("timeTableRelevant", OptionOf(Scalar()))
    def borderStation: SelectionBuilder[OperationLocation, Option[Boolean]] =
      _root_.caliban.client.SelectionBuilder
        .Field("borderStation", OptionOf(Scalar()))
  }

  type ParkingPriceOption
  object ParkingPriceOption {
    def id: SelectionBuilder[ParkingPriceOption, Int] =
      _root_.caliban.client.SelectionBuilder.Field("id", Scalar())
  ...
  object ParkingSpace {
    ...
    def id: SelectionBuilder[ParkingSpace, Int] =
      _root_.caliban.client.SelectionBuilder.Field("id", Scalar())
    ...
    def spaceNumber: SelectionBuilder[ParkingSpace, Option[String]] =
      _root_.caliban.client.SelectionBuilder
        .Field("spaceNumber", OptionOf(Scalar()))
    def responsibility: SelectionBuilder[ParkingSpace, Option[String]] =
      _root_.caliban.client.SelectionBuilder
        .Field("responsibility", OptionOf(Scalar()))
    ...
    def operator: SelectionBuilder[ParkingSpace, Option[String]] =
      _root_.caliban.client.SelectionBuilder
        .Field("operator", OptionOf(Scalar()))
    def operatorUrl: SelectionBuilder[ParkingSpace, Option[String]] =
      _root_.caliban.client.SelectionBuilder
        .Field("operatorUrl", OptionOf(Scalar()))
    def address[A](
        innerSelection: SelectionBuilder[MailingAddress, A]
    ): SelectionBuilder[ParkingSpace, Option[A]] =
      _root_.caliban.client.SelectionBuilder
    ...
    def isSpecialProductDb: SelectionBuilder[ParkingSpace, Boolean] =
      _root_.caliban.client.SelectionBuilder
        .Field("isSpecialProductDb", Scalar())
    ...
    def tariffPrices[A](
      ...
      _root_.caliban.client.SelectionBuilder
        .Field("tariffPrices", ListOf(Obj(innerSelection)))
    ...
    def tariffDiscount: SelectionBuilder[ParkingSpace, Option[String]] =
      _root_.caliban.client.SelectionBuilder
        .Field("tariffDiscount", OptionOf(Scalar()))
    ...
    def sloganEn: SelectionBuilder[ParkingSpace, Option[String]] =
      _root_.caliban.client.SelectionBuilder
        .Field("sloganEn", OptionOf(Scalar()))
  }

  type Photographer
  object Photographer {
    def name: SelectionBuilder[Photographer, String] =
      _root_.caliban.client.SelectionBuilder.Field("name", Scalar())
    def url: SelectionBuilder[Photographer, String] =
      _root_.caliban.client.SelectionBuilder.Field("url", Scalar())
  }

  type Picture
  object Picture {
    def id: SelectionBuilder[Picture, Int] =
      _root_.caliban.client.SelectionBuilder.Field("id", Scalar())
    def url: SelectionBuilder[Picture, String] =
      _root_.caliban.client.SelectionBuilder.Field("url", Scalar())
    def license: SelectionBuilder[Picture, String] =
      _root_.caliban.client.SelectionBuilder.Field("license", Scalar())
    def photographer[A](
        innerSelection: SelectionBuilder[Photographer, A]
    ): SelectionBuilder[Picture, A] = _root_.caliban.client.SelectionBuilder
  ...
  object PriceOption {
    def interval: SelectionBuilder[PriceOption, Option[Int]] =
      _root_.caliban.client.SelectionBuilder
        .Field("interval", OptionOf(Scalar()))
    def `type`: SelectionBuilder[PriceOption, String] =
      _root_.caliban.client.SelectionBuilder.Field("type", Scalar())
  ...
  object Product {
    ...
    def productCode: SelectionBuilder[Product, Option[Int]] =
      _root_.caliban.client.SelectionBuilder
        .Field("productCode", OptionOf(Scalar()))
    def productName: SelectionBuilder[Product, Option[String]] =
      _root_.caliban.client.SelectionBuilder
        .Field("productName", OptionOf(Scalar()))
  }

  type RegionalArea
  object RegionalArea {
    def number: SelectionBuilder[RegionalArea, Int] =
      _root_.caliban.client.SelectionBuilder.Field("number", Scalar())
    def name: SelectionBuilder[RegionalArea, String] =
      _root_.caliban.client.SelectionBuilder.Field("name", Scalar())
  ...
  object Route {
    def parts[A](
        innerSelection: SelectionBuilder[RoutePart, A]
    ): SelectionBuilder[Route, List[A]] = _root_.caliban.client.SelectionBuilder
      .Field("parts", ListOf(Obj(innerSelection)))
    def from[A](
        innerSelection: SelectionBuilder[Station, A]
    ): SelectionBuilder[Route, Option[A]] =
      _root_.caliban.client.SelectionBuilder
  ...
  object RoutePart {
    ...
    def product[A](
        innerSelection: SelectionBuilder[Product, A]
    ): SelectionBuilder[RoutePart, Option[A]] =
      _root_.caliban.client.SelectionBuilder
    ...
    def start: SelectionBuilder[RoutePart, String] =
      _root_.caliban.client.SelectionBuilder.Field("start", Scalar())
    def end: SelectionBuilder[RoutePart, String] =
      _root_.caliban.client.SelectionBuilder.Field("end", Scalar())
    def departingTrack[A](
        innerSelection: SelectionBuilder[Track, A]
    ): SelectionBuilder[RoutePart, Option[A]] =
      _root_.caliban.client.SelectionBuilder
  ...
  object Searchable {
    ...
    def operationLocations[A](
      ...
      _root_.caliban.client.SelectionBuilder
        .Field("operationLocations", ListOf(Obj(innerSelection)))
  }
  ...
  object Station {
    def primaryEvaId: SelectionBuilder[Station, Option[Int]] =
      _root_.caliban.client.SelectionBuilder
        .Field("primaryEvaId", OptionOf(Scalar()))
    def stationNumber: SelectionBuilder[Station, Option[Int]] =
      _root_.caliban.client.SelectionBuilder
        .Field("stationNumber", OptionOf(Scalar()))
    def primaryRil100: SelectionBuilder[Station, Option[String]] =
      _root_.caliban.client.SelectionBuilder
        .Field("primaryRil100", OptionOf(Scalar()))
    def name: SelectionBuilder[Station, String] =
      _root_.caliban.client.SelectionBuilder.Field("name", Scalar())
    def location[A](
        innerSelection: SelectionBuilder[Location, A]
      ...
      _root_.caliban.client.SelectionBuilder
        .Field("location", OptionOf(Obj(innerSelection)))
    def category: SelectionBuilder[Station, Int] =
      _root_.caliban.client.SelectionBuilder.Field("category", Scalar())
    ...
    def hasTravelNecessities: SelectionBuilder[Station, Boolean] =
      _root_.caliban.client.SelectionBuilder
        .Field("hasTravelNecessities", Scalar())
    def hasSteplessAccess: SelectionBuilder[Station, String] =
      _root_.caliban.client.SelectionBuilder
        .Field("hasSteplessAccess", Scalar())
    def hasMobilityService: SelectionBuilder[Station, String] =
      _root_.caliban.client.SelectionBuilder
        .Field("hasMobilityService", Scalar())
    def federalState: SelectionBuilder[Station, String] =
      _root_.caliban.client.SelectionBuilder.Field("federalState", Scalar())
    def regionalArea[A](
        innerSelection: SelectionBuilder[RegionalArea, A]
    ): SelectionBuilder[Station, A] = _root_.caliban.client.SelectionBuilder
      .Field("regionalArea", Obj(innerSelection))
    def facilities[A](
        innerSelection: SelectionBuilder[Facility, A]
    ): SelectionBuilder[Station, List[A]] =
      _root_.caliban.client.SelectionBuilder
        .Field("facilities", ListOf(Obj(innerSelection)))
    def mailingAddress[A](
        innerSelection: SelectionBuilder[MailingAddress, A]
    ): SelectionBuilder[Station, A] = _root_.caliban.client.SelectionBuilder
    ...
    def DBInformationOpeningTimes[A](
      ...
      _root_.caliban.client.SelectionBuilder
        .Field("DBInformationOpeningTimes", OptionOf(Obj(innerSelection)))
    def localServiceStaffAvailability[A](
        innerSelection: SelectionBuilder[OpeningTimes, A]
    ): SelectionBuilder[Station, Option[A]] =
      _root_.caliban.client.SelectionBuilder
        .Field("localServiceStaffAvailability", OptionOf(Obj(innerSelection)))
    def aufgabentraeger[A](
        innerSelection: SelectionBuilder[StationContact, A]
    ): SelectionBuilder[Station, A] = _root_.caliban.client.SelectionBuilder
      .Field("aufgabentraeger", Obj(innerSelection))
    def timeTableOffice[A](
        innerSelection: SelectionBuilder[StationContact, A]
    ): SelectionBuilder[Station, Option[A]] =
      _root_.caliban.client.SelectionBuilder
    ...
    def stationManagement[A](
        innerSelection: SelectionBuilder[StationContact, A]
    ): SelectionBuilder[Station, A] = _root_.caliban.client.SelectionBuilder
      .Field("stationManagement", Obj(innerSelection))
    def timetable[A](
        innerSelection: SelectionBuilder[Timetable, A]
    ): SelectionBuilder[Station, A] = _root_.caliban.client.SelectionBuilder
    ...
    def hasSteamPermission: SelectionBuilder[Station, Boolean] =
      _root_.caliban.client.SelectionBuilder
        .Field("hasSteamPermission", Scalar())
    def hasWiFi: SelectionBuilder[Station, Boolean] =
      _root_.caliban.client.SelectionBuilder.Field("hasWiFi", Scalar())
    ...
    def hasRailwayMission: SelectionBuilder[Station, Boolean] =
      _root_.caliban.client.SelectionBuilder
        .Field("hasRailwayMission", Scalar())
    ...
    def picture[A](
        innerSelection: SelectionBuilder[Picture, A]
    ): SelectionBuilder[Station, Option[A]] =
      _root_.caliban.client.SelectionBuilder
  ...
  object StationContact {
    def name: SelectionBuilder[StationContact, String] =
      _root_.caliban.client.SelectionBuilder.Field("name", Scalar())
    def shortName: SelectionBuilder[StationContact, Option[String]] =
      _root_.caliban.client.SelectionBuilder
        .Field("shortName", OptionOf(Scalar()))
    ...
    def phoneNumber: SelectionBuilder[StationContact, Option[String]] =
      _root_.caliban.client.SelectionBuilder
        .Field("phoneNumber", OptionOf(Scalar()))
  }

  type Timetable
  object Timetable {
    def nextArrivals[A](
        innerSelection: SelectionBuilder[TrainInStation, A]
    ): SelectionBuilder[Timetable, List[A]] =
      _root_.caliban.client.SelectionBuilder
  ...
  type Track
  object Track {
    def platform: SelectionBuilder[Track, String] =
      _root_.caliban.client.SelectionBuilder.Field("platform", Scalar())
    def number: SelectionBuilder[Track, String] =
      _root_.caliban.client.SelectionBuilder.Field("number", Scalar())
    def name: SelectionBuilder[Track, String] =
      _root_.caliban.client.SelectionBuilder.Field("name", Scalar())
    ...
    /** Height of the platform in cm
      */
    def height: SelectionBuilder[Track, Int] =
  ...
  object TrainInStation {
    ...
    def platform: SelectionBuilder[TrainInStation, String] =
      _root_.caliban.client.SelectionBuilder.Field("platform", Scalar())
    def time: SelectionBuilder[TrainInStation, String] =
      _root_.caliban.client.SelectionBuilder.Field("time", Scalar())
  ...
  object TravelCenter {
    ...
    def address[A](
        innerSelection: SelectionBuilder[MailingAddress, A]
    ): SelectionBuilder[TravelCenter, Option[A]] =
      _root_.caliban.client.SelectionBuilder
        .Field("address", OptionOf(Obj(innerSelection)))
  ...
  object Query {
    def routing[A](from: Int, to: Int)(
      ...
      _root_.caliban.client.SelectionBuilder.Field(
        ...
        ListOf(Obj(innerSelection)),
        arguments = List(
          Argument("from", from, "Int!")(encoder0),
          Argument("to", to, "Int!")(encoder1)
        )
      )
    def stationWithEvaId[A](
        evaId: Int
    )(innerSelection: SelectionBuilder[Station, A])(implicit
        encoder0: ArgEncoder[Int]
    ...
    def stationWithStationNumber[A](
      ...
      _root_.caliban.client.SelectionBuilder.Field(
        ...
        OptionOf(Obj(innerSelection)),
        arguments =
          List(Argument("stationNumber", stationNumber, "Int!")(encoder0))
      )
    ...
    )(innerSelection: SelectionBuilder[Searchable, A])(implicit
        encoder0: ArgEncoder[Option[String]]
    ): SelectionBuilder[_root_.caliban.client.Operations.RootQuery, A] =
      _root_.caliban.client.SelectionBuilder.Field(
        "search",
        Obj(innerSelection),
        arguments = List(Argument("searchTerm", searchTerm, "String")(encoder0))
      )
    def nearby[A](
        latitude: Double,
        longitude: Double,
        radius: Option[Int] = None
    )(innerSelection: SelectionBuilder[Nearby, A])(implicit
    ...
    def parkingSpace[A](
        id: Option[Int] = None
    )(innerSelection: SelectionBuilder[ParkingSpace, A])(implicit
        encoder0: ArgEncoder[Option[Int]]
    ): SelectionBuilder[_root_.caliban.client.Operations.RootQuery, Option[A]] =
      _root_.caliban.client.SelectionBuilder.Field(
        "parkingSpace",
        OptionOf(Obj(innerSelection)),
        arguments = List(Argument("id", id, "Int")(encoder0))
      )
  }
