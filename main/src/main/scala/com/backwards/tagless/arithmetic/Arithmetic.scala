...
object Arithmetic {
  ...
  /**
    ...
    */
  def translate[A](adtExp: ADT.Exp, taglessExp: Tagless.Exp[A]): A = adtExp match {
  ...
  object Reify extends Tagless.Exp[ADT.Exp] {
    override def lit(value: Int): ADT.Exp = ADT.Lit(value)
    override def add(lhs: ADT.Exp, rhs: ADT.Exp): ADT.Exp = ADT.Add(lhs, rhs)
    override def sub(lhs: ADT.Exp, rhs: ADT.Exp): ADT.Exp = ADT.Sub(lhs, rhs)
    override def mul(lhs: ADT.Exp, rhs: ADT.Exp): ADT.Exp = ADT.Mul(lhs, rhs)
  }
}