...
class ArithmeticSpec extends AnyWordSpec with Matchers {
  "Initial Alegbra" should {
    "evaluate" in {
      import tech.backwards.tagless.arithmetic.Arithmetic.ADT._
  ...
  "Final Algebra" should {
    "evaluate" in {
      import tech.backwards.tagless.arithmetic.Arithmetic.Tagless.Evaluate._
  ...
  "Equivalence" should {
    import tech.backwards.tagless.arithmetic.Arithmetic.ADT._
    import tech.backwards.tagless.arithmetic.Arithmetic._
    ...
    "Tagless -> ADT" in {
      import tech.backwards.tagless.arithmetic.Arithmetic.Reify
      import tech.backwards.tagless.arithmetic.Arithmetic.Tagless.Evaluate
