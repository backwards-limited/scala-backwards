...
/**
 * Type class with two operations: addition and multiplication
 */
object L1 extends App {
  ...
  object Op {
    ...
    def add[Left, Right](left: Left, right: Right)(implicit op: Op[Left, Right]): op.Result =
      op.add(left, right)

    def multiply[Left, Right](left: Left, right: Right)(implicit op: Op[Left, Right]): op.Result =
