...
class IdSpec extends AnyWordSpec with Matchers {
  ...
  import tech.backwards.fp.applicative.IdOps._
  ...
  "Id Applicative" should {
    "work" in {
      ...
      2) tech.backwards.fp.functor.FunctorOps._ brings in toFunctorOps
         This will "wrap" so long as there is an Id Functor instance
      3) tech.backwards.fp.functor.IdOps._ brings in an Id Functor instance
      ...
      */
      ...
      2) tech.backwards.fp.functor.FunctorOps._ brings in toFunctionFunctorOps
      3) Function is wrapped into FunctionFunctorOps and we call "<$>" with the provided Id
      4) The call to "<$>" looks for an Id Functor which is provided via tech.backwards.fp.functor.IdOps._
      ...
      */
      ...
      2) tech.backwards.fp.applicative.ApplicativeOps._ brings in toApplicativeOps
         This will "wrap" so long as there is an Id Applicative instance
      3) tech.backwards.fp.applicative.IdOps._ brings in an Id Applicative instance
